...
class ArcGIS(Geocoder):
    ...
    geocode_path = ...
    reverse_path = ...
    def __init__(self, username=..., password=..., *, referer=..., token_lifetime=..., scheme=..., timeout=..., proxies=..., user_agent=..., ssl_context=..., adapter_factory=..., auth_domain=..., domain=...) -> None:
        """
    ...
    def geocode(self, query, *, exactly_one=..., timeout=..., out_fields=...): # -> CoroutineType[Any, Any, Any | None] | None:
        """
    ...
    def reverse(self, query, *, exactly_one=..., timeout=..., distance=...): # -> CoroutineType[Any, Any, Any | None] | None:
        """
